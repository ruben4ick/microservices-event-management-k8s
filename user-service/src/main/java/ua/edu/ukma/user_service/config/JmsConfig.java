...
import ua.edu.ukma.user_service.integration.EventDto;
...
public class JmsConfig {
	...
	public MessageConverter jacksonJmsMessageConverter(ObjectMapper objectMapper) {
		...
		converter.setTypeIdMappings(Map.of("ua.edu.ukma.event_management_system.event.EventDto", EventDto.class));
